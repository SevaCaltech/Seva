                        ...
                        identityManager.resumeSession(SplashActivity.this, new StartupAuthResultHandler() {
                            ...
                            public void onComplete(StartupAuthResult authResults) {
                                if (authResults.isUserSignedIn()) {
                                    Log.d("StartupAuthResult", "Refresh Threshold: " + Integer.toString(authResults.getIdentityManager().getUnderlyingProvider().getRefreshThreshold()));
                                    Log.d("StartupAuthResult", "Session Duration: " + Integer.toString(authResults.getIdentityManager().getUnderlyingProvider().getSessionDuration()));
                                    Log.d("StartupAuthResult", "Session Expiration: " + (authResults.getIdentityManager().getUnderlyingProvider().getSessionCredentitalsExpiration()).toString());
